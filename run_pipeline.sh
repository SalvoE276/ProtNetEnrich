...
python3 src/ppi_data_retrieval.py $queryfile $working_dir
...
python3 src/network_analysis.py $working_dir/raw_network.gml $working_dir -stds 3 --all_metrics
...
python3 src/GSEA.py $working_dir/borda_ranking.json $working_dir GO_26
echo Removing redundant gseapy data...
